      ...
      <div className="w-full">
        ...
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-3">
            <Wallet className="w-8 h-8 text-[#0891B2]" />
            Wallet Manager
          </h1>
        ...
        {account && (network === 'Polygon Mainnet' || network === 'Polygon Amoy') && (
          <div className="mb-8 p-4 bg-[#0891B2]/5 border border-[#0891B2]/20 rounded-2xl flex flex-col md:flex-row items-center justify-between text-[#0891B2] text-sm font-bold gap-4">
            <div className="flex items-center gap-2">
              <Globe className="w-5 h-5 flex-shrink-0" />
            ...
            <button
              ...
              className="px-5 py-2 rounded-full border border-[#0891B2] font-bold text-sm text-[#0891B2] bg-[#0891B2]/5 hover:bg-[#0891B2]/10 transition-colors shrink-0 shadow-sm"
            >
