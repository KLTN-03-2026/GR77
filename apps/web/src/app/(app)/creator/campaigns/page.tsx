                                    ...
                                    {paginatedCampaigns.map((camp, index) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <td>
                                                    <button
                                                        className={`p-2 rounded-lg transition-colors group ${camp.status === 'COMPLETED' ? 'text-gray-300 cursor-not-allowed opacity-50' : 'text-blue-500 hover:text-blue-700 hover:bg-blue-50'}`}
                                                        onClick={(e) => {
                                                            e.stopPropagation();
                                                        ...
                                                        title={camp.status === 'COMPLETED' ? 'Campaign Completed' : 'Edit Campaign'}
                                                        disabled={camp.status === 'COMPLETED'}
                                                    >
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className={`w-5 h-5 ${camp.status !== 'COMPLETED' && 'group-hover:scale-110'} transition-transform`}>
