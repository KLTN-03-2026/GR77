            ...
            <div className="relative z-10 w-full flex items-center justify-center
                ...
                <div className="max-w-[340px] md:max-w-[460px] lg:max-w-[420px] xl:max-w-[440px] w-full px-4 flex-shrink-0">
                    ...
                    <div className="hidden md:block md:mb-8 lg:mb-0">
                        ...
                        <h2 className="text-center text-[#1a1a2e] lg:text-white text-[18px] md:text-[24px] lg:text-[22px] font-extrabold mb-2 md:mb-5 lg:mb-4 tracking-[3px] uppercase">
                            REGISTER
                        </h2>
                    </div>
                    ...
                    <div className="bg-transparent lg:bg-white/95 rounded-[20px] px-2 py-0 lg:px-6 lg:pt-5 lg:pb-4 lg:shadow-[0_6px_32px_rgba(0,0,0,0.08)] lg:backdrop-blur-sm">
                        <form onSubmit={onSubmit} noValidate>
                            {/* Error */}
                            {error && (
                                <div className="mb-3 lg:mb-3 py-2 px-3 lg:py-2 lg:px-3 bg-red-50 border border-red-300 rounded-lg text-red-700 text-[12px] lg:text-[12px] font-medium">
                                    {error}
                                </div>
                            )}
                            ...
                            <div className="mb-3 lg:mb-2">
                                ...
                                <div className="relative">
                                    ...
                                    <button
                                        ...
                                        className="absolute right-3 top-1/2 -translate-y-1/2 text-[#7FBDD0] hover:text-[#48C9E9] transition-colors focus:outline-none"
                                        tabIndex={-1}
                                    >
                                        {showPassword ? (
                                ...
                                <input
                                    ...
                                    className={`w-full px-3.5 py-[10px] lg:px-3.5 lg:py-[8px] bg-[#C1E8F4] border-2 rounded-lg outline-none text-[14px] lg:text-[14px] text-[#1a1a2e] transition-all duration-200 placeholder-[#7FBDD0]
                                        ${fieldErrors.confirmPassword
                                            ...
                                            : 'border-transparent focus:border-[#48C9E9] focus:ring-[3px] focus:ring-[#48C9E9]/25 focus:bg-[#D4F1FA]'}`}
                                />
                                <p className={`text-red-600 text-[12px] lg:text-[11px] mt-0.5 ml-0.5 font-semibold leading-tight h-[13px] ${fieldErrors.confirmPassword ? 'visible' : 'invisible'}`}>{fieldErrors.confirmPassword || '\u00A0'}</p>
                            </div>

                            {/* Terms */}
                            <div className="mb-5 lg:mb-3 flex items-start gap-2">
                                <input
                                    type="checkbox"
                                    id="terms-check"
                                    checked={agreed}
                                ...
                                />
                                <label htmlFor="terms-check" className="text-[12px] lg:text-[13px] text-gray-600 cursor-pointer leading-tight">
                                    I agree to the{" "}
                                    <Link href="/policies" target="_blank" className="font-bold text-gray-800 underline hover:text-[#48C9E9] transition-colors">
                            ...
                            {/* Login link */}
                            <p className="text-center text-[12px] lg:text-[13px] text-gray-600">
                                Already have an account?{" "}
                                <Link href="/login" className="font-bold text-gray-800 hover:text-[#48C9E9] transition-colors">
                                    Login
                                </Link>
                            </p>
                        </form>
